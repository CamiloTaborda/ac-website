...
import { useState, useRef } from 'react'; // useRef añadido para EmailJS
...
export default function Contacto() {
  ...
  const recaptchaRef = useRef(); // Referencia para resetear el captcha
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6 mb-10">
                ...
                <div>
                  <label className="block font-montserrat text-[#2d2d38] font-semibold mb-2">
                    Nombre completo
                  </label>
                  <input
                    type="text"
            ...
            <div>
              ...
              {/* INFO UBICACIÓN */}
               ...
               <div>
                <p className="font-montserrat text-[#2d2d38] font-semibold">
                 62a #2a-83
                </p>
                <p className="font-montserrat text-[#555] text-sm">
                Cali – Colombia
                </p>
                </div>
                </div>
